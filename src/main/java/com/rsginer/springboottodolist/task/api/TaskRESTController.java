...
public class TaskRESTController {
    ...
    @GetMapping
    @ResponseBody
    public Page<TaskDto> getTasks(@RequestParam(required = false) Pageable pageable, @AuthenticationPrincipal @Parameter(hidden = true) AppUserDetails appUserDetails) {
